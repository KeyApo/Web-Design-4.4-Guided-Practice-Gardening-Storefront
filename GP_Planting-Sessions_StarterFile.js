...
const plants = [
...

    {
        id: 2,
        name: "Dandelion",
        description: "A common yellow flower found everywhere.",
        price: 3.00,
        image:"images/DandelionFlower.jpg",
        alt: "Dandelion",
        sun: "☀️"
    },

    {
        id: 3,
        name: "Hibiscus",
        description: "Large tropical bush that yeilds beautiful flowers.",
        price: 42.99,
...

    {
        id: 4,
        name: "Rose",
        description: "A delicate brush that yeild beautiful but thorny red flowers.",
        price: 35.99,
